...
class LinkTest extends TestCase
{
    ...
    /** @test */
    function cannot_create_link_without_non_unique_slug()
    {
        $this->assertDatabaseCount('links', 1);
    ...
    function can_update_link()
    {
        ...
        $this->assertFalse(boolval($this->link->is_enabled));
        ...
        $this->assertEquals($this->link->url, 'https://google.ca');
        $this->assertEquals($this->link->slug, 'test-slug');
        $this->assertTrue(boolval($this->link->is_enabled));
    }

    /** @test */
    function can_update_link_with_save_slug()
    {
    ...
    /** @test */
    function redirect_to_non_existing_slug()
    {
        $this->assertDatabaseMissing('links', ['slug'=> 'random_slug_123']);
        $this->actingAs($this->user)
            ->get(route('redirect', 'random_slug_123'))
            ->assertStatus(404);
    }
}
